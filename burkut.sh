...
rat_virus_arsivi() { 
  echo -e " ${RED} RAT Virus Arsivi
    	1  - AhMyth - Android Rat : 
    	    ...
    	    ve 64 bit Hem'de Windows 32 ve 64  bit İşletim Sistemlerine Kurulmaktadır.
    	    AhMyth - Android Rat Github Linki;
    	    https://github.com/AhMyth/AAhMyth-Android-RAT
${ENDCOLOR}"
}

press_enter() {
  echo ""
  echo -n "	Enter Tuşuna Basarak Devam
